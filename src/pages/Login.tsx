        ...
        <div className="text-center" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="mt-5 text-start" style={{ maxWidth: '400px' }}>
            <div className="d-flex align-items-center mb-4">
              ...
              <div>
                <h5 className="mb-1">Track Collections</h5>
                <p className="mb-0" style={{ opacity: 0.9, fontSize: '0.9rem' }}>
                  Record milk collections on the go
                </p>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center mb-4">
              ...
              <div>
                <h5 className="mb-1">Location Tracking</h5>
                <p className="mb-0" style={{ opacity: 0.9, fontSize: '0.9rem' }}>
                  Real-time location updates for routes
                </p>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                <h5 className="mb-1">Duty Management</h5>
                <p className="mb-0" style={{ opacity: 0.9, fontSize: '0.9rem' }}>
                  Manage your duty status easily
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div style={{ width: '100%', maxWidth: '450px' }}>
          ...
          <div className="d-none d-lg-block mb-5">
            ...
            <p className="text-muted">Sign in to access your driver dashboard</p>
          </div>
